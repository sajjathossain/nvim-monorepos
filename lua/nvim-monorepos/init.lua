...
M.find_files = function()
  ...
  picker.show_project_picker(project_directories, "find_files", plugin_config or {})
end
...
M.find_in_files = function()
  ...
  picker.show_project_picker(project_directories, "find_in_files", plugin_config or {})
end
